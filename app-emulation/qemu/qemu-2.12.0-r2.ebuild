...
PATCHES=(
	"${FILESDIR}"/qemu-2.5.0-cflags.patch
	"${FILESDIR}"/qemu-2.5.0-sysmacros.patch
	"${FILESDIR}"/qemu-2.11.1-capstone_include_path.patch
	"${FILESDIR}"/qemu-2.12.0-AMD-SMT.patch
	"${FILESDIR}"/qemu-2.12.0-audio.patch
	"${FILESDIR}"/qemu-2.12.0-cpu-pinning.patch
	"${FILESDIR}"/qemu-2.12.0-ps2-fixes.patch
)
