...
SRC_URI="https://github.com/SSSD/sssd/releases/download/${PN}-${MY_PV}/${PN}-${PV}.tar.gz"
KEYWORDS="~amd64 ~arm ~arm64 ~hppa ~ia64 ~m68k ~mips ~ppc ~ppc64 ~s390 ~sparc ~x86"

LICENSE="GPL-3"
SLOT="0"
IUSE="acl autofs +locator +netlink nfsv4 nls +manpages samba selinux sudo ssh test nss systemd"
RESTRICT="!test? ( test )"
